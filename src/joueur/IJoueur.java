...
public interface IJoueur {
	...
	/**
	 * Le nombre de mana augmente de 1 à chaque tour. Mais il ne pourra pas dépasser
	...
	/**
	 * Nombre de manas encore disponibles pendant le tour. Le stock est rempli à
	 * chaque début de tour avec les manas potentiels.
	 * 
	...
	/**
	 * La main est l'ensemble des cartes piochées par le joueur mais non encore
	 * mises en jeu.
	 * 
	...
	/**
	 * Le jeu d'un joueur est composé des cartes placées sur le plateau
	 * 
	...
	/**
	 * Permet de rechercher une carte en jeu par rapport à un bout de son nom (grâce
	 * à la fonction contains de la classe String).
	 * 
	 * @param nomCarte
	 *            C'est une chaine de caractères qui correspond au nom ou à un bout
	 ...
	 * (grâce Ã la fonction contains de la classe String).
	 * 
	 * @param nomCarte
	 *            C'est une chaine de caractères qui correspond au nom ou à un bout
	 *            du nom de la carte que l'on souhaite
	 * @return la premiÃ¨re carte trouvÃ©e ou null si aucune carte ne correspond
	 */
	ICarte getCarteEnMain(String nomCarteMain);

	/**
	 * Il se passe beaucoup de choses au moment où le joueur prend le tour. Son
	 * nombre de mana augmente, son stock est réinitialisé en conséquence, les
	 * serviteurs en attente deviennent jouables, etc.
	 * 
	 * @throws HearthstoneException
	 *             Si jamais le joueur tente de prendre le tour alors que ce n'est
	 *             pas Ã lui de le faire...
	 */
	...
	/**
	 * Au début de chaque tour, une carte du deck est choisie aléatoirement et est
	 * placée dans la main du joueur. Elle est naturellement enlevée de son deck.
	 * 
	 * @throws HearthstoneException
	 *             En cas de problème, une exception...
	 */
	void piocher() throws HearthstoneException;

	/**
	 * Pendant le tour, un joueur peut tenter de prendre une carte de sa main et de
	 * la placer sur le board. Si c'est possible, elle est retirée de la main et
	 * placée sur le board. Evidemment, il faut faire attention aux effets de mise
	 * en jeu Ãéentuels, aux contrôles, etc.
	 * 
	 * @param carte
	 *            La carte jouée
	 * @throws HearthstoneException
	 ...
	 * la placer sur le board. Si c'est possible, elle est retirée de la main et
	 * placée sur le board. Evidemment, il faut faire attention aux effets de mise
	 * en jeu éventuels, aux contrôles, etc. C'est la même chose que la fonction
	 ...
	 * Utiliser un serviteur consistera à attaqué la cible (un autre serviteur ou le
	 * héros), à utiliser un sort, etc.
	 * 
	 * @param carte
	 *            La carte
	 * @param cible
	 *            La cible
	 * @throws HearthstoneException
	 *             En cas de problÃ¨me, une exception...
	 */
	void utiliserCarte(ICarte carte, Object cible) throws HearthstoneException;

	/**
	 * Cette fonction utilise le pouvoir du héros du joueur pour faire quelque chose
	 * sur la cible...
	 * 
	 * @param cible
	 *            La cible...
	...
	/**
	 * Lorsqu'une carte a fini sa vie (un serviteur qui meut, un sort qui vient
	 * d'être utilisé, ...), il faut gérer le jeu (une carte en moins...), ainsi que
	 * les effets liés à la disparition de la carte (Rale d'agonie par exemple).
	 * 
	 * @param carte
