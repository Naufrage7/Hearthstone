...
public interface IPlateau {
	 ...
	 *             si l'on essaie d'ajouter un 3e joueur par exemple, si le joueur
	 *             est null, etc...
	 */
	 ...
	 * 
	 * @param joueur
	 *            Le nouveau joueur courant
	 * @throws HearthstoneException
	 *             si le nouveau joueur est null, etc. (faut tout tester
	 *             naturellement...)
	 */
	 ...
	 * 
	 * @param joueur
	 *            dont on veut l'adversaire
	 * @return le joueur adverse
	 * @throws HearthstoneException
	 *             si le param est null ou si le param ne correspond à aucun des 2
	 *             joueurs de la partie, etc.
	 */
	IJoueur getAdversaire(IJoueur joueur) throws HearthstoneException;

	/**
	 * Ca démarre la partie. Il faut déterminer aléatoirement le joueur qui
	 * commence, etc.
	 * 
	 * @throws HearthstoneException
	 *             si 2 joueurs ne sont pas ajoutés, etc....
	 */
	...
	/**
	 * Le joueur passé en paramètre vient de décider de finir son tour. Du coup, le
	 * plateau doit gérer le changement de joueur courant (entre autres)
	 * 
	 * @param joueur
	 *            le joueur qui a fini son tour et qui passe la main
	 * @throws HearthstoneException
	 *             si le joueur qui passe son tour, n'avait pas le tour, alors c'est
	 *             qu'il fait n'importe quoi !
	 */
	void finTour(IJoueur joueur) throws HearthstoneException;

	/**
	 * Le héros du joueur adverse du joueur passé en paramètre est mort. Donc le
	 * joueur à gagné !
	 * 
	 * @param joueur
	 *            celui qui a gagné
	 * @throws HearthstoneException
	 *             au cas on souhaite...tricher !
	 */
